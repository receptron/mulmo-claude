...
const frMessages = {
  ...
  pluginManageSkills: {
    ...
    scheduleTitle: "Planifier « {name} »",
    scheduleTypeLabel: "Type de planification",
    scheduleDaily: "Quotidien",
    scheduleInterval: "Intervalle",
    scheduleTimeLabel: "Heure de la journée",
    scheduleTimeHint: "Heure locale. Exécution chaque jour à cette heure.",
    scheduleEvery: "Toutes les",
    scheduleUnit: "Unité",
    scheduleUnitMinutes: "minutes",
    scheduleUnitHours: "heures",
    scheduleSubmit: "Planifier",
    scheduleSaving: "Planification…",
    scheduleDescription: "Exécuter la skill {name} selon la planification",
    errScheduleFailed: "Échec de la planification : {error}",
