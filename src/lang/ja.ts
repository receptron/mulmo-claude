...
const jaMessages = {
  ...
  pluginManageSkills: {
    ...
    btnRun: "実行",
    btnSchedule: "予約",
    scheduleTitle: "「{name}」を定期実行",
    scheduleTypeLabel: "実行頻度",
    scheduleDaily: "毎日",
    scheduleInterval: "間隔",
    scheduleTimeLabel: "実行時刻",
    scheduleTimeHint: "ローカル時刻。毎日この時刻に実行されます。",
    scheduleEvery: "間隔",
    scheduleUnit: "単位",
    scheduleUnitMinutes: "分",
    scheduleUnitHours: "時間",
    scheduleSubmit: "予約する",
    scheduleSaving: "予約中…",
    scheduleDescription: "{name} スキルを定期実行",
    errScheduleFailed: "予約に失敗: {error}",
