...
const esMessages = {
  ...
  settingsMcpTab: {
    ...
    dockerNonWorkspaceWarning: "⚠ Contiene rutas fuera del área de trabajo — no se resolverán dentro de Docker.",
  ...
  pluginScheduler: {
    ...
    noScheduled: "No hay elementos programados",
  ...
  pluginNews: {
    ...
    selectPrompt: "Selecciona un elemento para leer.",
    empty: "No hay noticias en esta vista.",
    unread: "Sin leer",
  ...
  pluginManageSource: {
    ...
    addAndRebuild: "Añadir + Reconstruir",
    emptyPickPack: "Aún no hay fuentes registradas. Elige un paquete de inicio abajo, pulsa {addBold} arriba, o pide a Claude que registre una.",
    emptyAddStrong: "+ Añadir",
    registering: "Registrando + obteniendo…",
    removeLabel: "Quitar",
    removingLabel: "Quitando…",
    todaysBrief: "Resumen de hoy",
    todaysBriefLoading: "Cargando el resumen de hoy…",
    briefNone: "Aún no se ha escrito un resumen para esta fecha. Pulsa Reconstruir ahora.",
    briefEmpty: "El resumen de hoy está vacío.",
    briefLoadFailed: "Error al cargar el resumen",
    lastRebuildSummary: "Última reconstrucción ({date}): {itemCount} elementos de {planned} fuentes, {duplicates} duplicados descartados.",
    archiveErrorsSuffix: "({count} errores de archivado)",
    kindRss: "RSS",
    kindGithubRel: "Releases de GitHub",
    kindGithubIss: "Issues de GitHub",
    kindArxiv: "arXiv",
    kindGithubReleases: "Releases de GitHub",
    kindGithubIssues: "Issues de GitHub",
    briefDateLabel: "({date})",
    primaryRssPlaceholder: "https://news.ycombinator.com/rss",
    primaryGithubPlaceholder: "https://github.com/owner/repo (u owner/repo)",
    primaryArxivPlaceholder: "cat:cs.CL",
    primaryRssHint: "URL del feed (RSS 2.0 / Atom / RDF)",
    primaryGithubRelHint: "URL del repo de GitHub u owner/repo — obtiene releases",
    primaryGithubIssHint: "URL del repo de GitHub u owner/repo — obtiene issues",
    primaryArxivHint: "Consulta de búsqueda de arXiv (ej. cat:cs.CL o au:hinton)",
    confirmRemove: '¿Quitar la fuente "{slug}"?',
    flashRegistered: "Registrada. Obteniendo elementos nuevos…",
    flashRebuildReady: "Listo: {itemCount} elementos de {planned} fuente.|Listo: {itemCount} elementos de {planned} fuentes.",
    flashRebuildComplete: "Reconstrucción completa: {itemCount} elementos de {planned} fuentes.",
    flashRebuildFailed: "Error en la reconstrucción: {error}",
    flashRegisterFailed: "Error al registrar la fuente",
    flashRegisterSucceededRebuildFailed: "Registro correcto pero fallo al reconstruir: {error}",
    flashRemoved: 'Quitada "{slug}".',
    flashRemoveFailed: "Error al quitar: {error}",
    flashRefreshListFailed: "Error al actualizar las fuentes: {error}",
  ...
  pluginManageSkills: {
    ...
    scheduleTitle: 'Programar "{name}"',
    scheduleTypeLabel: "Tipo de programación",
    scheduleDaily: "Diaria",
    scheduleInterval: "Intervalo",
    scheduleTimeLabel: "Hora del día",
    scheduleTimeHint: "Hora local. Se ejecuta cada día a esta hora.",
    scheduleEvery: "Cada",
    scheduleUnit: "Unidad",
    scheduleUnitMinutes: "minutos",
    scheduleUnitHours: "horas",
    scheduleSubmit: "Programar",
    scheduleSaving: "Programando…",
    scheduleDescription: "Ejecutar la skill {name} en horario programado",
    errScheduleFailed: "Error al programar: {error}",
