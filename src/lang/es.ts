...
const esMessages = {
  ...
  remoteHost: {
    ...
    offline: "Host remoto sin conexión",
    uid: "uid {uid}",
    signIn: "Iniciar sesión con Google",
    connecting: "Conectando…",
    disconnect: "Desconectar",
    disconnecting: "Desconectando…",
    noToken: "El inicio de sesión de Google no devolvió idToken",
    connectFailed: "Error al conectar",
    disconnectFailed: "Error al desconectar",
    signInFailed: "Error al iniciar sesión con Google",
    signInStorageBlocked: "El almacenamiento del navegador está pausado en esta pestaña. Recarga la página y vuelve a iniciar sesión.",
    signInPopupBlocked: "Se bloqueó la ventana emergente de inicio de sesión. Permite las ventanas emergentes para este sitio y vuelve a intentarlo.",
    signInUnauthorizedDomain: "No se permite iniciar sesión desde esta dirección. Abre MulmoClaude en localhost e inténtalo de nuevo.",
    signInCancelled: "Se canceló el inicio de sesión.",
    signInNetworkFailed: "No se pudo conectar con Google. Comprueba tu conexión de red e inténtalo de nuevo.",
  ...
  dashboard: {
    empty: "Aún no hay colecciones favoritas.",
    emptyHint: "Fija una colección (★) para verla aquí.",
    viewTable: "Tabla",
