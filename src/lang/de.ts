...
const deMessages = {
  ...
  remoteHost: {
    ...
    offline: "Remote-Host offline",
    uid: "uid {uid}",
    signIn: "Mit Google anmelden",
    connecting: "Verbinden…",
    disconnect: "Trennen",
    disconnecting: "Wird getrennt…",
    noToken: "Google-Anmeldung hat kein idToken zurückgegeben",
    ...
    signInStorageBlocked: "Der Browser-Speicher ist für diesen Tab pausiert. Lade die Seite neu und melde dich erneut an.",
    signInPopupBlocked: "Das Anmeldefenster wurde blockiert. Erlaube Pop-ups für diese Seite und versuche es erneut.",
    signInUnauthorizedDomain: "Von dieser Adresse ist keine Anmeldung möglich. Öffne MulmoClaude über localhost und versuche es erneut.",
    signInCancelled: "Die Anmeldung wurde abgebrochen.",
    signInNetworkFailed: "Google konnte nicht erreicht werden. Prüfe deine Netzwerkverbindung und versuche es erneut.",
  ...
  dashboard: {
    empty: "Noch keine Lieblingssammlungen.",
    emptyHint: "Hefte eine Sammlung (★) an, um sie hier zu sehen.",
    viewTable: "Tabelle",
