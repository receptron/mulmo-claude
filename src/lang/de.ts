...
const deMessages = {
  ...
  pluginManageSkills: {
    ...
    btnRun: "Ausführen",
    btnSchedule: "Planen",
    scheduleTitle: "{name} planen",
    scheduleTypeLabel: "Zeitplan-Typ",
    scheduleDaily: "Täglich",
    scheduleInterval: "Intervall",
    scheduleTimeLabel: "Uhrzeit",
    scheduleTimeHint: "Lokale Zeit. Wird täglich zu dieser Uhrzeit ausgeführt.",
    scheduleEvery: "Alle",
    scheduleUnit: "Einheit",
    scheduleUnitMinutes: "Minuten",
    scheduleUnitHours: "Stunden",
    scheduleSubmit: "Planen",
    scheduleSaving: "Wird geplant…",
    scheduleDescription: "Skill {name} planmäßig ausführen",
    errScheduleFailed: "Planen fehlgeschlagen: {error}",
