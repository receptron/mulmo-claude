...
Session handoff note. Read this first, then `plans/done/fix-2052-windows-docker-esm-hook.md`
...
never fires") was a wrong diagnosis — see `plans/done/fix-2052-windows-docker-esm-hook.md` F1–F5.
...
- `docs/windows-docker-ci.md`, `plans/done/fix-2052-windows-docker-esm-hook.md` — records.
