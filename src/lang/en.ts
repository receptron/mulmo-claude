...
const enMessages = {
  ...
  remoteHost: {
    ...
    noToken: "Google sign-in returned no idToken",
    connectFailed: "Connect failed",
    disconnectFailed: "Disconnect failed",
    signInFailed: "Google sign-in failed",
    signInStorageBlocked: "Browser storage is paused for this tab. Reload the page, then sign in again.",
    signInPopupBlocked: "The sign-in popup was blocked. Allow popups for this site in your browser, then try again.",
    signInUnauthorizedDomain: "Sign-in isn't allowed from this address. Reopen MulmoClaude at localhost and try again.",
    signInCancelled: "Sign-in was cancelled.",
    signInNetworkFailed: "Couldn't reach Google. Check your network connection and try again.",
