...
const koMessages = {
  ...
  remoteHost: {
    ...
    noToken: "Google 로그인에서 idToken을 반환하지 않았습니다",
    connectFailed: "연결 실패",
    disconnectFailed: "연결 해제 실패",
    signInFailed: "Google 로그인 실패",
    signInStorageBlocked: "이 탭의 브라우저 저장소가 일시 중지되었습니다. 페이지를 새로고침한 뒤 다시 로그인해 주세요.",
    signInPopupBlocked: "로그인 팝업이 차단되었습니다. 브라우저에서 이 사이트의 팝업을 허용한 뒤 다시 시도해 주세요.",
    signInUnauthorizedDomain: "이 주소에서는 로그인할 수 없습니다. localhost로 MulmoClaude를 다시 연 뒤 시도해 주세요.",
    signInCancelled: "로그인이 취소되었습니다.",
    signInNetworkFailed: "Google에 연결할 수 없습니다. 네트워크 연결을 확인한 뒤 다시 시도해 주세요.",
  ...
  dashboard: {
    empty: "즐겨찾는 컬렉션이 아직 없습니다.",
    emptyHint: "컬렉션을 고정(★)하면 여기에 표시됩니다.",
    viewTable: "테이블",
    viewCalendar: "캘린더",
    viewKanban: "칸반",
