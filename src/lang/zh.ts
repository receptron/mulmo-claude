...
const zhMessages = {
  ...
  remoteHost: {
    ...
    disconnect: "断开连接",
    disconnecting: "断开中…",
    noToken: "Google 登录未返回 idToken",
    connectFailed: "连接失败",
    disconnectFailed: "断开连接失败",
    signInFailed: "Google 登录失败",
    signInStorageBlocked: "此标签页的浏览器存储已暂停。请重新加载页面，然后再次登录。",
    signInPopupBlocked: "登录弹出窗口被拦截。请在浏览器中允许本站弹出窗口，然后重试。",
    signInUnauthorizedDomain: "无法从此地址登录。请通过 localhost 重新打开 MulmoClaude 后重试。",
    signInCancelled: "登录已取消。",
    signInNetworkFailed: "无法连接到 Google。请检查网络连接后重试。",
    statusFailed: "加载状态失败",
  ...
  settingsModal: {
    ...
    navAriaLabel: "设置分区",
    googleTab: {
      description: "关联 Google 账号后，这台机器即可直接调用 Google API（首先是日历）。刷新令牌仅保存在本机，除 Google 外不会发送到任何服务器。",
      statusLinked: "已关联",
      statusNotLinked: "未关联",
      statusPending: "正在等待浏览器中的授权完成…",
      connect: "关联 Google 账号",
      unlink: "解除关联",
