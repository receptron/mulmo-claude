...
\node[draw, dashed, gray, inner xsep=26pt, inner ysep=8pt, fit=(above)(below), label={[lab, gray]above:written by the AI}] {};
\node[draw, dashed, gray, inner sep=8pt, fit=(enf), label={[lab, gray, align=center]above:platform\\ compiler, ruleset, hosting}] {};
\end{tikzpicture}
