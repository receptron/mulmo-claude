...
const koMessages = {
  ...
  pluginNews: {
    title: "뉴스",
    itemCount: "읽지 않음 {unread} / 전체 {total}",
    filterAll: "전체",
    filterUnread: "읽지 않음",
    allSources: "전체",
    markAllRead: "모두 읽음으로 표시",
    selectPrompt: "기사를 선택하세요.",
    empty: "표시할 뉴스가 없습니다.",
    unread: "읽지 않음",
    openOriginal: "원문 열기",
  ...
  pluginManageSkills: {
    ...
    btnRun: "실행",
    btnSchedule: "예약",
    scheduleTitle: '"{name}" 예약 실행',
    scheduleTypeLabel: "실행 주기",
    scheduleDaily: "매일",
    scheduleInterval: "간격",
    scheduleTimeLabel: "실행 시각",
    scheduleTimeHint: "로컬 시간 기준. 매일 이 시각에 실행됩니다.",
    scheduleEvery: "매",
    scheduleUnit: "단위",
    scheduleUnitMinutes: "분",
    scheduleUnitHours: "시간",
    scheduleSubmit: "예약하기",
    scheduleSaving: "예약 중…",
    scheduleDescription: "{name} 스킬 예약 실행",
    errScheduleFailed: "예약 실패: {error}",
