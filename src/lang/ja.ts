...
const jaMessages = {
  ...
  remoteHost: {
    ...
    offline: "リモートホスト: オフライン",
    uid: "uid {uid}",
    signIn: "Google でサインイン",
    connecting: "接続中…",
    disconnect: "切断",
    disconnecting: "切断中…",
    noToken: "Google サインインで idToken が取得できませんでした",
    connectFailed: "接続に失敗しました",
    disconnectFailed: "切断に失敗しました",
    signInFailed: "Google サインインに失敗しました",
    signInStorageBlocked: "このタブのブラウザ保存領域が停止しています。ページを再読み込みしてから、もう一度サインインしてください。",
    signInPopupBlocked: "サインイン用のポップアップがブロックされました。ブラウザでこのサイトのポップアップを許可してから、もう一度お試しください。",
    signInUnauthorizedDomain: "このアドレスからはサインインできません。localhost で MulmoClaude を開き直してからお試しください。",
    signInCancelled: "サインインがキャンセルされました。",
    signInNetworkFailed: "Google に接続できませんでした。ネットワーク接続を確認してから、もう一度お試しください。",
  ...
  dashboard: {
    empty: "お気に入りのコレクションはまだありません。",
    emptyHint: "コレクションをピン留め（★）するとここに表示されます。",
    viewTable: "テーブル",
    viewCalendar: "カレンダー",
    viewKanban: "カンバン",
