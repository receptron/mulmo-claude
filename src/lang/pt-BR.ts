...
const ptBRMessages = {
  ...
  remoteHost: {
    ...
    offline: "Host remoto off-line",
    uid: "uid {uid}",
    signIn: "Entrar com o Google",
    connecting: "Conectando…",
    disconnect: "Desconectar",
    disconnecting: "Desconectando…",
    noToken: "O login do Google não retornou idToken",
    connectFailed: "Falha ao conectar",
    disconnectFailed: "Falha ao desconectar",
    signInFailed: "Falha ao entrar com o Google",
    signInStorageBlocked: "O armazenamento do navegador está pausado nesta aba. Recarregue a página e entre novamente.",
    signInPopupBlocked: "O pop-up de login foi bloqueado. Permita pop-ups para este site no navegador e tente de novo.",
    signInUnauthorizedDomain: "Não é possível entrar a partir deste endereço. Abra o MulmoClaude em localhost e tente de novo.",
    signInCancelled: "O login foi cancelado.",
    signInNetworkFailed: "Não foi possível conectar ao Google. Verifique sua conexão de rede e tente de novo.",
  ...
  dashboard: {
    empty: "Ainda não há coleções favoritas.",
    emptyHint: "Fixe uma coleção (★) para vê-la aqui.",
    viewTable: "Tabela",
