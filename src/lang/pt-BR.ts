...
const ptBRMessages = {
  ...
  pluginManageSkills: {
    ...
    scheduleTypeLabel: "Tipo de agendamento",
    scheduleDaily: "Diário",
    scheduleInterval: "Intervalo",
    scheduleTimeLabel: "Horário do dia",
    scheduleTimeHint: "Horário local. Executa todos os dias neste horário.",
    scheduleEvery: "A cada",
    scheduleUnit: "Unidade",
    scheduleUnitMinutes: "minutos",
    scheduleUnitHours: "horas",
    scheduleSubmit: "Agendar",
    scheduleSaving: "Agendando…",
    scheduleDescription: "Executar a skill {name} no horário agendado",
    errScheduleFailed: "Falha ao agendar: {error}",
