...
\end{tikzpicture}
\caption{The line. The AI's freedom differs on the two sides. The page above can only ask, through five intents; the declaration below decides, and is enforced by a system that neither the page nor the AI can reach.}
\label{fig:line}
\end{figure}
