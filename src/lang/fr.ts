...
const frMessages = {
  ...
  remoteHost: {
    ...
    offline: "Hôte distant hors ligne",
    uid: "uid {uid}",
    signIn: "Se connecter avec Google",
    connecting: "Connexion…",
    disconnect: "Déconnecter",
    disconnecting: "Déconnexion…",
    noToken: "La connexion Google n'a renvoyé aucun idToken",
    connectFailed: "Échec de la connexion",
    disconnectFailed: "Échec de la déconnexion",
    signInFailed: "Échec de la connexion Google",
    signInStorageBlocked: "Le stockage du navigateur est suspendu pour cet onglet. Rechargez la page, puis reconnectez-vous.",
    signInPopupBlocked: "La fenêtre de connexion a été bloquée. Autorisez les fenêtres pop-up pour ce site, puis réessayez.",
    signInUnauthorizedDomain: "La connexion depuis cette adresse n'est pas autorisée. Rouvrez MulmoClaude sur localhost, puis réessayez.",
    signInCancelled: "La connexion a été annulée.",
    signInNetworkFailed: "Impossible de joindre Google. Vérifiez votre connexion réseau, puis réessayez.",
  ...
  settingsModal: {
    ...
    notificationsTab: {
      ...
      enableLabel: "Envoyer une Web Push à la fin d'une tâche",
  ...
  dashboard: {
    empty: "Aucune collection favorite pour l'instant.",
    emptyHint: "Épinglez une collection (★) pour la voir ici.",
    viewTable: "Tableau",
