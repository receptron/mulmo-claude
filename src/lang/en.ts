...
const enMessages = {
  ...
  systemFiles: {
    ...
    interests: {
      title: "News notification filter profile",
      summary:
        "Scores articles for the notification bell. The agent updates this file when you mention interests in chat; you can also hand-edit it. Loose validation: malformed entries are silently dropped.",
    },
    mcp: {
      title: "MCP server registry",
      summary:
        "External MCP servers exposed to the agent. Edit via Settings → MCP, or hand-edit JSON. Stdio servers run inside the sandbox image; paths must be workspace-relative when Docker is enabled.",
    },
    settings: {
      title: "App settings",
      summary:
        "Per-workspace app configuration loaded fresh on every agent invocation. Currently holds extra allowed-tool entries (e.g. Claude Code built-in MCP prefixes).",
    },
    schedulerTasks: {
      title: "User-defined automations",
      summary:
        "Scheduled tasks the agent created or you authored. Edit via the Automations page; hand-editing the JSON is supported but the file is rewritten by the agent on changes.",
    },
    schedulerOverrides: {
      title: "Per-task scheduling overrides",
      summary:
        "Manual disable/snooze flags applied on top of the task definitions in tasks.json. The agent updates this when you toggle automations from the UI.",
    },
    newsReadState: {
      title: "Notification read state",
      summary:
        "Tracks which news items you've seen so the bell doesn't re-alert. Pure runtime state — safe to delete (you'll just see one round of re-notifications).",
    },
    schedulerItems: {
      title: "Calendar items",
      summary:
        "Calendar events surfaced in the Calendar view. Written by the agent from chat; hand-editing the JSON works but you'll lose changes if the agent rewrites the file.",
    },
    todosItems: {
      title: "Todos kanban",
      summary: "Tasks shown in the Todos page. The agent reads and writes this file in response to chat instructions; hand-editing is supported.",
    },
    todosColumns: {
      title: "Todos kanban columns",
      summary: "Column definitions for the Todos kanban (id, title, color). You own this file — edit freely to reshape the board.",
    },
    wikiIndex: {
      title: "Wiki index",
      summary: "Generated table of contents for your wiki. The agent rebuilds this from the page set; hand edits are overwritten on the next index pass.",
    },
    wikiLog: {
      title: "Wiki edit log",
      summary:
        "Append-only log of wiki edits. The agent appends entries automatically; do not reorder or delete past entries — newer logic depends on the chronological order.",
    },
    wikiSummary: {
      title: "Wiki summary",
      summary: "AI-generated summary of the wiki's overall topics. Refreshed on demand by the agent.",
    },
    wikiSchema: {
      title: "Wiki schema definition",
      summary: "Structural schema the agent uses to keep wiki pages internally consistent. Format-sensitive — small edits can desync the wiki indexer.",
    },
    memory: {
      title: "Long-term memory",
      summary:
        "Long-lived facts the agent extracts from your conversations. Hand-editable: prune entries that are no longer accurate, or add facts you want the agent to remember.",
    },
    summariesIndex: {
      title: "Summaries index",
      summary: "Index of daily and topic summaries under conversations/summaries/. Regenerated by the journal indexer; hand edits are clobbered.",
    },
    rolesJson: {
      title: "Role definition (config)",
      summary:
        "Per-role configuration used by the role selector — display name, icon, default model, plugin enablement. You own this file; hand-edit to customize a role.",
    },
    rolesMd: {
      title: "Role system prompt",
      summary: "The Markdown system prompt sent to Claude when you select this role. Hand-edit freely — changes take effect on the next chat run.",
    },
    sourceFeed: {
      title: "Source feed registration",
      summary: "Markdown frontmatter describing one news/article source (URL, slug, category). You own this file; the source pipeline reads it on every run.",
    },
    sourceState: {
      title: "Source pipeline runtime state",
      summary:
        "Per-source bookkeeping (last-fetched cursor, dedupe hashes, error counts). Pure runtime state — deleting forces a re-fetch but is otherwise safe.",
    },
    journalDaily: {
      title: "Daily summary",
      summary:
        "AI-generated summary of one day's conversations. The journal subsystem regenerates this on schedule; manual edits will be lost on the next pass.",
    },
    journalTopic: {
      title: "Topic summary",
      summary: "AI-generated summary scoped to one topic across multiple days. Regenerated by the journal indexer; manual edits will not survive.",
    },
  },
  settingsMcpTab: {
    explanation:
  ...
  pluginPresentForm: {
    ...
    submit: "Submit",
    submitted: "Submitted",
    progress: "{filled} / {total} required fields completed",
