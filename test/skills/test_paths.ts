...
import { projectSkillsDir, projectSkillPath, projectSkillDir } from "../../server/workspace/skills/paths.js";
...
describe("projectSkillsDir / projectSkillPath / projectSkillDir", () => {
  ...
  it("appends the slug + SKILL.md for projectSkillPath", () => {
    ...
    assert.equal(got, path.join(workspace, ".claude", "skills", "fix-ci", "SKILL.md"));
  });
