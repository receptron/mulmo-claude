...
const enMessages = {
  ...
  pluginManageSkills: {
    ...
    scheduleTimeLabel: "Time of day",
    scheduleTimeHint: "Local time, runs every day.",
    scheduleEvery: "Every",
    scheduleUnit: "Unit",
    scheduleUnitMinutes: "minutes",
    scheduleUnitHours: "hours",
    scheduleSubmit: "Schedule",
    scheduleSaving: "Scheduling…",
    scheduleDescription: "Run the {name} skill on schedule",
    errScheduleFailed: "Failed to schedule: {error}",
